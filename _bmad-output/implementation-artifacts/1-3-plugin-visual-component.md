...
- **Per-plugin structural review (2026-07-31), assessed but not yet acted on:** real aspect ratios measured directly from each reference screenshot — DeEsser 2 1.46:1, ChromaVerb 1.29:1, Tape Delay 1.23:1, Overdrive 1.47:1, Flanger 1.42:1, Phaser 2.07:1, Chorus 1.43:1 (Compressor's own real ratio is 1.29:1 for comparison). None of the other 7 appear to have Compressor's specific "full-height meter-into-knob column" pattern — ChromaVerb's Damping EQ curve and Tape Delay's multi-section layout are the two structurally closest to warranting their own dedicated look, matching how they already got bespoke section groupings in the original Task 1 pass. This is a scan, not a spike — none of the 7 have gone through Compressor's iterative validation process; whether/which get one is a founder call, not decided here.
